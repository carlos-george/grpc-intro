package br.com.til.grpc.client.ssl;
...
public class BankClientTest {
	...
	public void setUp() throws SSLException {
		...
		SslContext sslContext = GrpcSslContexts.forClient()
			.trustManager(new File("./ssl-tls/ca.cert.pem")).build();
		
		ManagedChannel managedChannel = NettyChannelBuilder.forAddress("localhost", 9095)
